...
object ColorPicker extends WebComponent("sl-color-picker") with ControlledInput {
  ...
  lazy val gridWidth: StyleProp[String] & u.Length[DSP] = lengthStyle("--grid-width")

  /** The height of the color grid. */
  lazy val gridHeight: StyleProp[String] & u.Length[DSP] = lengthStyle("--grid-height")

  /** The size of the color grid's handle. */
  lazy val gridHandleSize: StyleProp[String] & u.Length[DSP] = lengthStyle("--grid-handle-size")

  /** The height of the hue and alpha sliders. */
  lazy val sliderHeight: StyleProp[String] & u.Length[DSP] = lengthStyle("--slider-height")

  /** The diameter of the slider's handle. */
  lazy val sliderHandleSize: StyleProp[String] & u.Length[DSP] = lengthStyle("--slider-handle-size")

  /** The size of each predefined color swatch. */
  lazy val swatchSize: StyleProp[String] & u.Length[DSP] = lengthStyle("--swatch-size")
